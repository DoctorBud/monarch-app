...
web.wrapRouteGet(app, '/services/status', [], serviceStatusHandler, errorResponse);
...
web.wrapRouteGet(app, '/page/{page}', ['page'], pageByPageHandler, errorResponse);
...
web.wrapRouteGet(app, '/docs/{p1}/{p2}/{p3}', ['p1', 'p2', 'p3'], docHandler, errorResponse);
web.wrapRouteGet(app, '/docs/{p1}/{p2}', ['p1', 'p2'], docHandler, errorResponse);
web.wrapRouteGet(app, '/docs/{p1}', ['p1'], docHandler, errorResponse);
...
web.wrapRouteGet(app, '/search/{term}', ['term'], searchHandler, errorResponse);
...
web.wrapRouteGet(app, '/about/sources.{fmt}', ['fmt'], sourcesHandler, errorResponse);
web.wrapRouteGet(app, '/about/sources', [], sourcesHandler, errorResponse);
...
// Order matters here in the declaration of these routes.
web.wrapRouteGet(app, '/model/{id}.{fmt}', ['id', 'fmt'], modelByIdHandler, errorResponse);
web.wrapRouteGet(app, '/model/{id}', ['id'], modelByIdHandler, errorResponse);
...
// Order matters here in the declaration of these routes.
web.wrapRouteGet(app, '/genotype/{id}.{fmt}', ['id', 'fmt'], genotypeByIdHandler, errorResponse);
web.wrapRouteGet(app, '/genotype/{id}', ['id'], genotypeByIdHandler, errorResponse);
...
web.wrapRouteGet(app, '/case/{id}.{fmt}', ['id', 'fmt'], caseByIdHandler, errorResponse);
web.wrapRouteGet(app, '/case/{id}', ['id'], caseByIdHandler, errorResponse);
...
web.wrapRouteGet(app, '/gene', [], geneLandingHandler, errorResponse);
web.wrapRouteGet(app, '/gene/', [], geneLandingHandler, errorResponse);
...
web.wrapRouteGet(app, '/model', [], modelLandingHandler, errorResponse);
web.wrapRouteGet(app, '/model/', [], modelLandingHandler, errorResponse);
web.wrapRouteGet(app, '/genotype', [], genotypeLandingHandler, errorResponse);
web.wrapRouteGet(app, '/genotype/', [], genotypeLandingHandler, errorResponse);
...
// Order matters here in the declaration of these routes.
web.wrapRouteGet(app, '/neighborhood/{id}/{depth}/{direction}/{relationship}.{fmt}', ['id', 'depth', 'direction', 'relationship', 'fmt'], neighborhoodByIdDepthDirectionRelationshipHandler, errorResponse);
web.wrapRouteGet(app, '/neighborhood/{id}/{depth}/{direction}/{relationship}', ['id', 'depth', 'direction', 'relationship'], neighborhoodByIdDepthDirectionRelationshipHandler, errorResponse);
...
// Order matters here in the declaration of these routes.
web.wrapRouteGet(app, '/compare/{x}/{y}.{fmt}', ['x', 'y', 'fmt'], compareHandler, errorResponse);
web.wrapRouteGet(app, '/compare/{x}/{y}', ['x', 'y'], compareHandler, errorResponse);
...
// Order matters here in the declaration of these routes.
web.wrapRouteGet(app, '/reference/{id}.{fmt}', ['id', 'fmt'], referenceByIdHandler, errorResponse);
web.wrapRouteGet(app, '/reference/{id}', ['id'], referenceByIdHandler, errorResponse);
...
// Order matters here in the declaration of these routes.
web.wrapRouteGet(app, '/query/orthologs/{id}.{fmt}', ['id', 'fmt'], queryOrthologsByIdHandler, errorResponse);
web.wrapRouteGet(app, '/query/orthologs/{id}', ['id'], queryOrthologsByIdHandler, errorResponse);
...
web.wrapRouteGet(app, '/literature', [], literatureLandingHandler, errorResponse);
web.wrapRouteGet(app, '/literature/', [], literatureLandingHandler, errorResponse);
...
// Order matters here in the declaration of these routes.
web.wrapRouteGet(app, '/literature/{id}.{fmt}', ['id', 'fmt'], literatureByIdHandler, errorResponse);
web.wrapRouteGet(app, '/literature/{id}', ['id'], literatureByIdHandler, errorResponse);
...
web.wrapRouteGet(app, '/score', [], scoreHandler, errorResponse);
web.wrapRoutePost(app, '/score', [], scoreHandler, errorResponse);
...
// Order matters here in the declaration of these routes.
web.wrapRouteGet(app, '/simsearch/disease/{id}.{fmt}', ['id', 'fmt'], simsearchDiseaseByIdHandler, errorResponse);
web.wrapRouteGet(app, '/simsearch/disease/{id}', ['id'], simsearchDiseaseByIdHandler, errorResponse);
...
web.wrapRouteGet(app, '/phenopacket', [], phenoPacketHandler, errorResponse);
...
web.wrapRouteGet(app, '/annotate/text', [], annotateTextHandler, errorResponse);
...
// Order matters here in the declaration of these routes.
web.wrapRouteGet(app, '/annotate_minimal/text/{id}.{fmt}', ['id', 'fmt'], annotateMinimalTextHandler, errorResponse);
web.wrapRouteGet(app, '/annotate_minimal/text/{id}', ['id'], annotateMinimalTextHandler, errorResponse);
...
// Order matters here in the declaration of these routes.
web.wrapRouteGet(app, '/scigraph/dynamic*/{id}.{fmt}', ['id', 'fmt'], scigraphDynamicHandler, errorResponse);
web.wrapRouteGet(app, '/scigraph/dynamic*/{id}', ['id'], scigraphDynamicHandler, errorResponse);
...
// Order matters here in the declaration of these routes.
web.wrapRouteGet(app, '/admin/introspect.{fmt}', ['fmt'], adminIntrospectHandler, errorResponse);
web.wrapRouteGet(app, '/admin/introspect', [], adminIntrospectHandler, errorResponse);


web.wrapRouteGet(app, '/admin/cache/info', [],
...
web.wrapRouteGet(app, '/admin/clear-cache', [],
    function(request) {
...
web.wrapRouteGet(app, '/home', [], homeHandler, errorResponse);
...
web.wrapRouteGet(app, '/phenotype/{id}.{fmt}', ['id', 'fmt'], phenotypeByIdHandler, errorResponse);
web.wrapRouteGet(app, '/phenotype/{id}', ['id'], phenotypeByIdHandler, errorResponse);
...
// Order matters here in the declaration of these routes.
web.wrapRouteGet(app, '/phenotype/{id}/{section}.{fmt}', ['id', 'section', 'fmt'], phenotypeByIdSectionHandler, errorResponse);
web.wrapRouteGet(app, '/phenotype/{id}/{section}', ['id', 'section'], phenotypeByIdSectionHandler, errorResponse);
...
// Order matters here in the declaration of these routes.
web.wrapRouteGet(app, '/disease/{id}.{fmt}', ['id', 'fmt'], diseaseByIdHandler, errorResponse);
web.wrapRouteGet(app, '/disease/{id}', ['id'], diseaseByIdHandler, errorResponse);
...
// Order matters here in the declaration of these routes.
web.wrapRouteGet(app, '/anatomy/{id}.{fmt}', ['id', 'fmt'], anatomyByIdHandler, errorResponse);
web.wrapRouteGet(app, '/anatomy/{id}', ['id'], anatomyByIdHandler, errorResponse);
...
// Order matters here in the declaration of these routes.
web.wrapRouteGet(app, '/disease/{id}/{section}.{fmt}', ['id', 'section', 'fmt'], diseaseByIdSectionHandler, errorResponse);
web.wrapRouteGet(app, '/disease/{id}/{section}', ['id', 'section'], diseaseByIdSectionHandler, errorResponse);
...
// Order matters here in the declaration of these routes.
web.wrapRouteGet(app, '/gene/{id}.{fmt}', ['id', 'fmt'], geneByIdHandler, errorResponse);
web.wrapRouteGet(app, '/gene/{id}', ['id'], geneByIdHandler, errorResponse);
...
// Order matters here in the declaration of these routes.
web.wrapRouteGet(app, '/variant/{id}.{fmt}', ['id', 'fmt'], variantByIdHandler, errorResponse);
web.wrapRouteGet(app, '/variant/{id}', ['id'], variantByIdHandler, errorResponse);

//Sequence Feature - Sub-pages
//Example: /gene/NCIBGene:12166/phenotype_associations.json
//Currently only works for json or rdf output

web.wrapRouteGet(app, '/gene/{id}/{section}.{fmt?}', ['id', 'section', 'fmt'], fetchFeatureSection);
web.wrapRouteGet(app, '/variant/{id}/{section}.{fmt?}', ['id', 'section', 'fmt'], fetchFeatureSection);
web.wrapRouteGet(app, '/genotype/{id}/{section}.{fmt?}', ['id', 'section', 'fmt'], fetchFeatureSection);
web.wrapRouteGet(app, '/model/{id}/{section}.{fmt?}', ['id', 'section', 'fmt'], fetchFeatureSection);
web.wrapRouteGet(app, '/case/{id}/{section}.{fmt?}', ['id', 'section', 'fmt'], fetchFeatureSection);
...
// Order matters here in the declaration of these routes.
web.wrapRouteGet(app, '/association/{id}.{fmt}', ['id', 'fmt'], associationByIdHandler, errorResponse);
web.wrapRouteGet(app, '/association/{id}', ['id'], associationByIdHandler, errorResponse);
...
// web.wrapRouteGet(app, '/app.bundle.css', [], cssBundleFileHandler, errorResponse);
...
web.wrapRouteGet(app, '/analyze/{datatype}.{fmt}', ['datatype', 'fmt'], analyzeByDatatypeGetHandler, errorResponse);
web.wrapRouteGet(app, '/analyze/{datatype}/', ['datatype'], analyzeByDatatypeGetHandler, errorResponse);
web.wrapRouteGet(app, '/analyze/{datatype}', ['datatype'], analyzeByDatatypeGetHandler, errorResponse);
...
// Order matters here in the declaration of these routes.
web.wrapRouteGet(app, '/resolve/{id}.{fmt}', ['id', 'fmt'], resolveByIdHandler, errorResponse);
web.wrapRouteGet(app, '/resolve/{id}', ['id'], resolveByIdHandler, errorResponse);

// Duplicate the above for /{id}
web.wrapRouteGet(app, '/{id}.{fmt}', ['id', 'fmt'], rootPathHandler, errorResponse);
web.wrapRouteGet(app, '/{id}', ['id'], rootPathHandler, errorResponse);
...
web.wrapRouteGet(app, '/downloads/{id}.{fmt}', ['id', 'fmt'], downloadByIdHandler, errorResponse);
