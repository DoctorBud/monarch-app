...
bbop.monarch.Engine.prototype.fetchClassInfo = async function(id, opts) {
    ...
    console.log('before getVocabularyTermByID', id);
    var res = await engine.getVocabularyTermByID(id);
    console.log('after getVocabularyTermByID', id);
...
bbop.monarch.Engine.prototype.fetchUrlWithExchangeObject = async function(url, params, method) {
    ...
    if (method === 'post') {
        ...
        var res = await AsyncRequest.post(postOptions);
    }
    else {
        var getOptions = {
            url: url,
        ...
        var res = await AsyncRequest.get(getOptions);
    }
 ...
 *
 */
bbop.monarch.Engine.prototype.fetchAssociations = function(filters, limit, personality, facet, orFilter) {
    var engine = this;
...
bbop.monarch.Engine.prototype.fetchGenotypes = function(id) {
    ...
    var golrResponse = engine.fetchAssociations(filters, 5000);
...
bbop.monarch.Engine.prototype.fetchPhenotypes = function(id) {
    ...
    var golrResponse = engine.fetchAssociations(filters, 5000, personality);
