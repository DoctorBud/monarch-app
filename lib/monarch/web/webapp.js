...
if (false) {
// Delete this or implement as a supported feature
...
web.wrapRouteGet(app, '/labs/cluster', [], clusterPageHandler, errorResponse);
}
...
// A routing page different non-production demonstrations and tests.
web.wrapRouteGet(app, '/labs/cy-path-demo', [],
    function (request){
        var info = newInfo();
        addCoreRenderers(info);
...
// A routing page different non-production demonstrations and tests.
web.wrapRouteGet(app, '/labs/cy-explore-demo', [],
            function (request){
        var info = newInfo();
        addCoreRenderers(info);
