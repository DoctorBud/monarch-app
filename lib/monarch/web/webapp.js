...
function searchApiHandler(request, term) {
    ...
    console.log('searchApiHandler...', term);
    var results = engine.search(term, request.query, ["category", "taxon_label"], rowsPerPage, start);
    console.log('...searchApiHandler', term, results);
