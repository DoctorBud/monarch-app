...
function errorResponse(errorStatus, errorMessage) {
    ...
    return web.wrapHTML(renderWithBase(template, info));
}
...
function blankNodeHandler(request) {
    var info = newInfo();
    addCoreRenderers(info);
    return web.wrapHTML(renderWithBase('blank-node.mustache', info));
}
...
function serviceStatusHandler(request) {
    ...
    return web.wrapHTML(renderWithBase('status.mustache', info));
}
...
function pageByPageHandler(request, page) {
    ...
    if (info.title) {
        return web.wrapHTML(renderWithBase(page + '.mustache', info));
    }
    else {
...
function searchHandler(request, term) {
    try {
        ...
        return web.wrapHTML(renderWithBase('search_results.mustache', info));
    }
    catch(err) {
...
function sourcesHandler(request, fmt) {
    try {
        ...
        return web.wrapHTML(renderWithBase('sources.mustache', info));
    }
    catch(err) {
        return errorResponseWithObject(err);
    }
...
function diseaseLandingHandler(request) {
    ...
    return web.wrapHTML(renderWithBase('disease_main.mustache', info));
}
...
function phenotypeLandingHandler(request) {
    ...
    return web.wrapHTML(renderWithBase('phenotype_main.mustache', info));
}
...
function modelByIdHandler(request, id, fmt) {
    try {
        ...
        return web.wrapHTML(renderWithBase('node.mustache', info));
    }
    catch(err) {
        return errorResponseWithObject(err);
    }
...
function geneLandingHandler(request) {
    ...
    return web.wrapHTML(renderWithBase('gene_main.mustache', info));
}
...
function genotypeLandingHandler(request){
    ...
    return web.wrapHTML(renderWithBase('genotype_main.mustache', info));
}
...
function modelLandingHandler(request){
    ...
    return web.wrapHTML(renderWithBase('model_main.mustache', info));
}
...
function literatureLandingHandler(request){
    ...
    return web.wrapHTML(renderWithBase('literature_main.mustache', info));
}
...
function literatureByIdHandler(request, id, fmt) {
    ...
    return web.wrapHTML(renderWithBase('literature.mustache', info));
}
...
function annotateTextHandler(request) {
    ...
    return web.wrapHTML(renderWithBase('annotate.mustache', info));
}
...
function annotateMinimalTextHandler(request, fmt) {
    ...
    return web.wrapHTML(renderWithBase('annotate_minimal.mustache', info));
}
...
function homeHandler(request) {
  ...
  return web.wrapHTML(renderWithBase('home-page.mustache', info));
}
...
function anatomyByIdHandler(request, id, fmt) {
    ...
    if (/_/.test(id)) {
        engine.log("ID contains underscore, replacing with : and redirecting");
        var newID = id.replace("_",":");
        return web.wrapRedirect(genURL('anatomy', newID));
    }
...
function associationByIdHandler(request, id, fmt){
        ...
        try {
          ...
          //Curify ID if needed
            ...
            return web.wrapHTML(renderWithBase('associations.mustache', info));
        } catch(err) {
            return errorResponseWithObject(err);
        }
}
...
function analyzeByDatatypePostHandler(request, datatype, fmt) {
    ...
    return web.wrapHTML(renderWithBase('analyze.mustache', info));
}
