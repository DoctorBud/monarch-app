...
bbop.monarch.Engine.prototype.fetchTaxon = function(id) {
    ...
    var neighbors = engine.getGraphNeighbors(leader, 1, 'RO:0002162', 'BOTH', false, engine.config.scigraph_data_url);
...
bbop.monarch.Engine.prototype.fetchInheritance = function (id) {
    const engine = this;
    ...
    const neighbors = engine.getGraphNeighbors(
        id, params.depth,
...
bbop.monarch.Engine.prototype.annotateText = function(txt, opts) {
    ...
    var neighbors = engine.getGraphNeighbors(id_list, 1, 'RO:0002162', 'BOTH', false, engine.config.scigraph_data_url);
    var graph = new bbop.model.graph();
    graph.load_json(neighbors);
 ...
 */
 bbop.monarch.Engine.prototype.autocomplete = function(term, category, limit) {
    ...
    //HACK
    // solr.monarchinitiative.org expects the category 'Phenotype'
    // solr-dev... expects 'phenotype'

    if (this.config.search_url === 'https://solr.monarchinitiative.org/solr/search/') {
    ...
    // console.log('searchGolrManager.get_query_url()', searchGolrManager.get_query_url())
...
bbop.monarch.Engine.prototype.searchOverOntologies = function(term, opts) {
    ...
    try {
        var neighbors = engine.getGraphNeighbors(id_list, 1, 'RO:0002162',
...
bbop.monarch.Engine.prototype.fetchAssociationCount = function(filter, facet, orFilter) {
